...
rgb = pl.gray2rgb(gray, cmap, [0, 1], False)  # rgb --> double, [0, 1]
rgb = pl.gray2rgb(gray, cmap, [0, 255], False)  # rgb --> double, [0., 255.]
# rgb = pl.gray2rgb(gray, cmap, [0, 255], 'uint8')  # rgb --> uint8, [0, 255]
