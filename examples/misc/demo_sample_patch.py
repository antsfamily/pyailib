...
# y2 = pl.tensor2patch(x, n=n, size=size, axis=(0, 1), step=(64, 64), shake=(0, 0), mode='slidegrid', seed=2020)
...
Y1 = np.zeros(osize, dtype=x.dtype)
Y2 = np.zeros(osize, dtype=x.dtype)
...
y1 = pl.tensor2patch(x, n=n, size=size, axis=(0, 1), step=(64, 64), shake=(0, 0), mode='slidegrid', seed=2020)
y2 = pl.tensor2patch(x, n=n, size=size, axis=(0, 1), step=(64, 64), shake=(30, 30), mode='slidegrid', seed=2020)
