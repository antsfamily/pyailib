...
y1, mask1 = pl.dnsampling(x, ratio=ratio1, axis=[0, 1], smode=smode, omode=omode, extra=True)
y2, mask2 = pl.dnsampling(x, ratio=ratio2, axis=[0, 1], smode=smode, omode=omode, extra=True)
